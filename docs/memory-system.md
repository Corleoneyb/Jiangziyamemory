...
大事国史、小事地方史 — 见 **[灵台分级.md](灵台分级.md)**（资治通鉴 / 起居注 / 分榜私卷）。  
升格与准入争议 → **[议事殿.md](议事殿.md)** + **[价值评定纲要.md](价值评定纲要.md)**。
...
| 国史（拟） | `chronicle/` | 立宪、殿议结论、册封大事 |
| 日常流水 / 对话要点 | `memories/YYYY-MM-DD.md` | 追加、带时间戳 |
| 地方史 / 私卷（拟） | `memories/carbon/<标识>/` | 个人史，默认不升国史 |
...
| 方式 | 作用 |
|------|------|
| **开卷单页** [`docs/kaijuan.md`](kaijuan.md) | 新对话把此文件路径或链接发给 Agent 即可（桌面 `姜子牙开卷.txt` 含路径） |
| **姜子牙，封卷入灵台** | 封卷：将本场已决/待办/未决写入当日 `memories/YYYY-MM-DD.md` 的 `## 🧾 封卷` |

开卷后更新 `kaijuan.md` 的「上次封卷摘要」，便于次日接续。
